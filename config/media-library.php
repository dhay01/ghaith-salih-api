...
return [
     ...
     */
    /*
     * Gigapixel originals are the reason this is not the 10MB default. The real
     * ceiling in production is PHP's upload_max_filesize / post_max_size, which
     * must be raised to match — see the README.
     */
    'max_file_size' => (int) env('MEDIA_MAX_FILE_SIZE', 1024 * 1024 * 1024 * 5), // 5GB
